...
router.post("/add-service", isAuth, [
  ...
  expressValidator.check("price").trim().notEmpty(),
  expressValidator.check("description").trim().notEmpty(),
  expressValidator.check("city").trim().notEmpty(),
  expressValidator.check("specialty").trim().notEmpty(),
